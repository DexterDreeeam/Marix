"use strict";
  ...
  const I18N = {
    en: {
      ...
      activeReloadBannerMessage: "Reload all file information?",
      activeReloadBannerCountdown: "Hides in {seconds}s",
      activeReloadBannerReload: "Reload",
      activeReloadBannerDismiss: "Later",
    ...
    zh: {
      ...
      activeReloadBannerMessage: "是否重载所有文件信息？",
      activeReloadBannerCountdown: "{seconds} 秒后消失",
      activeReloadBannerReload: "重载",
      activeReloadBannerDismiss: "稍后",
